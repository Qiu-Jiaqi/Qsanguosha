deity = sgs.Package("deity", sgs.Package_GeneralPack)
sgs.LoadTranslationTable {
    ["deity"] = "神"
}
-- 神甄姬
shenzhenji = sgs.General(deity, "shenzhenji", "careerist", "4", false, true)
-- 珠联璧合：曹丕
shenzhenji:addCompanion("caopi")
-- 神赋：结束阶段开始时，若你的手牌数为：奇数，你可对一名其他角色造成1点雷电伤害，若造成其死亡，你可重复此流程；
...
sgs.insertRelatedSkills(deity, qixian, qixian_trigger)
sgs.LoadTranslationTable {
    ["shenzhenji"] = "神甄姬",
    ["&shenzhenji"] = "神甄姬",
    ["#shenzhenji"] = "洛水凌波",
    ...
    ["shenfu"] = "神赋",
    [":shenfu"] = "结束阶段开始时，若你的手牌数为：奇数，你可对一名其他角色造成1点雷电伤害，若造成其死亡，你可重复此流程；偶数，你可令一名本回合未指定过的角色摸一张牌或弃置其一张手牌，若执行后该角色的手牌数等于其体力值，你可重复此流程。",
    ["$shenfu1"] = "河洛之神，诗赋可抒。",
    ["$shenfu2"] = "云神鱼游，罗扇掩面。",
